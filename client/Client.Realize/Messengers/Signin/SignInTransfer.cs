...
{
    [AutoInject(ServiceLifetime.Singleton, typeof(ISignInTransfer))]
    public sealed class SignInTransfer : ISignInTransfer
    {
        ...
        public async Task<CommonTaskResponseInfo<bool>> SignIn(bool autoReg = false)
        {
            ...
            CommonTaskResponseInfo<bool> success = new CommonTaskResponseInfo<bool>
                { Data = false, ErrorMsg = string.Empty };
