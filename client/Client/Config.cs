...
namespace Client
{
    ...
    public sealed class ClientConfig
    {
        ...
        {
            get { return UseIpv6 && NetworkHelper.IPv6Support ? IPAddress.IPv6Any : IPAddress.Any; }
        }
        ...
        {
            get { return UseIpv6 && NetworkHelper.IPv6Support ? IPAddress.IPv6Loopback : IPAddress.Loopback; }
        }
