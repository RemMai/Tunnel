...
namespace Common.Server.Servers.RUdp
{
    ...
    [AutoInject(ServiceLifetime.Singleton, typeof(IUdpServer))]
    public sealed class UdpServer : IUdpServer
    {
        ...
        readonly Semaphore maxNumberConnects = new(1, 1);
        readonly BoolSpace maxNumberConnectingNumberSpace = new(false);
