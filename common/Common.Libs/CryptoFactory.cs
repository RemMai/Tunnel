...
namespace Common.Libs
{
    ...
    [AutoInject(ServiceLifetime.Singleton,typeof(ICryptoFactory))]
    ...
    [AutoInject(ServiceLifetime.Singleton,typeof(IAsymmetricCrypto))]
    ...
    [AutoInject(ServiceLifetime.Singleton,typeof(ISymmetricCrypto))]
